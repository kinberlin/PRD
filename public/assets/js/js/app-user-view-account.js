$(function() {
        ...
        columnDefs: [{
            ...
            },
            {
                ...
                render: function(e, t, a, s) {
                    var n = a.project_name,
                        l = a.framework,
                        r = a.project_image;
                    return '<div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper"><div class="avatar avatar-sm me-3">' + (r ? '<img src="' + assetsPath + "img/icons/brands/" + r + '" alt="Project Image" class="rounded-circle">' : '<span class="avatar-initial rounded-circle bg-label-' + ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random()) + 1] + '">' + (r = (((r = (n = a.full_name).match(/\b\w/g) || []).shift() || "") + (r.pop() || "")).toUpperCase()) + "</span>") + '</div></div><div class="d-flex flex-column"><span class="text-truncate fw-medium">' + n + '</span><small class="text-muted">' + l + "</small></div></div>"
                }
            },
            {
                targets: 3,
            ...
            },
            {
                ...
                render: function(e, t, a, s) {
                    ...
                    return '<div class="d-flex flex-column"><small class="mb-1">' + l + '</small><div class="progress w-100 me-3" style="height: 6px;"><div class="progress-bar ' + n + '" style="width: ' + l + '" aria-valuenow="' + l + '" aria-valuemin="0" aria-valuemax="100"></div></div></div>'
                }
            },
            {
                targets: 5,
    ...
    t.length && (t.DataTable({
        ...
        columnDefs: [{
            ...
            },
            {
                targets: 1,
                render: function(e, t, a, s) {
                    return '<a href="app-invoice-preview.html"><span class="fw-medium">#' + a.invoice_id + "</span></a>"
                }
            },
            {
                targets: 2,
                render: function(e, t, a, s) {
                    var n = a.invoice_status,
                        l = a.due_date;
                    return "<span data-bs-toggle='tooltip' data-bs-html='true' title='<span>" + n + '<br> <span class="fw-medium">Balance:</span> ' + a.balance + '<br> <span class="fw-medium">Due Date:</span> ' + l + "</span>'>" + {
    ...
    }), $(".dt-buttons > .btn-group > button").removeClass("btn-secondary")), t.on("draw.dt", function() {
