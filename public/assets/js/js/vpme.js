    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            setTimeout(function () {
                ...
                window.location.href = '/employee/pme/validate/' + x.val() + '/' + x.data("extra-info");
            }, 2000);
...
function rejpme(id) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            setTimeout(function () {
                console.log(x.data("extra-info"));
                window.location.href = '/employee/pme/cancel/' + x.val() + '/' + x.data("extra-info");
            }, 2000);
...
(function () {
    var /*t = document.querySelector("#basic-alert"),
        ...
        x = document.querySelector("#valpme");
    ...
    if (x) {
        x.onclick = function () {
            Swal.fire({
                ...
                console.log(+ ' ' + $('#valpme').data("extra-info"));
                setTimeout(function () {
                    window.location.href = '/employee/pme/validate/' + $('#valpme').val() + '/' + $('#valpme').data("extra-info");
                    /*$.get('/employee/pme/validate/' + $('#valpme').val() + '/' + $('#valpme').data("extra-info"), function (data) {
