...
@section('mainContent')
    ...
    @foreach ($data as $d)
                        ...
                        <form class="formChangePassword" method="POST"
                            ...
                            <div class="row">
                                <div class="mb-3 col-12 col-sm-6 form-password-toggle">
                                    <label class="form-label" for="newPassword30{{ $d->id }}">Nouveau Mot
                                        de Passe</label>
                                    <div class="input-group input-group-merge">
                                        <input class="form-control" type="password"
                                            id="newPassword30{{ $d->id }}" name="newPassword"
                                            placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" />
                                ...
                                <div class="mb-3 col-12 col-sm-6 form-password-toggle">
                                    <label class="form-label" for="confirmPassword30{{ $d->id }}">Confirmer
        ...
        <div class="modal-onboarding modal fade animate__animated" id="majemp{{ $d->id }}" tabindex="-1"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form class="modal-content text-center" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="modal-header border-0">
                        <a class="text-muted close-label" href="javascript:void(0);" data-bs-dismiss="modal">close</a>
                        ...
                        <div class="onboarding-media">
                            <div class="mx-2">
                                <img src="../../assets/img/illustrations/pencil-rocket.png"
                                    alt="girl-unlock-password-light" class="img-fluid" style="width: 136px; height:140px"
                        ...
                        <div class="onboarding-content mb-0">
                            ...
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="firstnamemaj{{ $d->id }}" class="form-label">Nom</label>
                                            <input class="form-control" placeholder="Entrez le Nom" name="firstname"
                                                type="text" value="{{ $d->firstname }}" maxlength="20"
                                                tabindex="0" id="firstnamemaj{{ $d->id }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="lastnamemaj{{ $d->id }}" class="form-label">Prenom</label>
                                            <input class="form-control" placeholder="Entrez le Prenom" name="lastname"
                                                type="text" value="{{ $d->lastname }}" tabindex="0"
                                                maxlength="20" id="lastnamemaj{{ $d->id }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="phonemaj{{ $d->id }}" class="form-label">Telephone</label>
                                            <input class="form-control" placeholder="No. Tel" type="text"
                                                value="{{ $d->phone }}" maxlength="10" tabindex="0"
                                                name="phone" id="phonemaj{{ $d->id }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="postemaj{{ $d->id }}" class="form-label">Intitulé de
                                                Poste</label>
                                            <input class="form-control" placeholder="Poste actuel" type="text"
                                                value="{{ $d->poste }}" maxlength="30" tabindex="0"
                                                name="poste" id="postemaj{{ $d->id }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            <label for="emailmaj{{ $d->id }}" class="form-label">Adresse
                                                Mail</label>
                                            <input class="form-control" placeholder="Email" name="email"
                                                type="email" value="{{ $d->email }}" tabindex="0"
                                                id="emailmaj{{ $d->id }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="avatar avatar-xl">
                                            <img id="pvwProfile{{ $d->id }}"
                                                ...
                                                alt="Avatar-{{ $d->firstname }}" class="rounded">
                                        </div>
                                    </div>
                                    <div class="col-sm-9">
                                        <div class="mb-3">
                                            <label for="profileImg{{ $d->id }}" class="form-label">Choisir une
                                                photo de
                                                Profil</label>
                                            <input type="file" name="image" class="form-control-file fileInput"
                                                id="profileImg{{ $d->id }}"
                                                data-img="pvwProfile{{ $d->id }}" tabindex="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
