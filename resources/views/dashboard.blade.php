        ...
        <div class="card-body row p-0 pb-3">
            <div class="col-12 col-md-8 card-separator">
                ...
                <div class="col-12 col-lg-7">
                    <p>Your progress this week is Awesome. let's keep it up and get a lot of points
                        reward !</p>
                </div>
        ...
        <div class="col-12 col-xl-4 col-md-6">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="popularInstructors"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="bx bx-dots-vertical-rounded"></i>
                        </button>
        ...
        <div class="col-12 col-xl-4 col-md-6">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="topCourses"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="bx bx-dots-vertical-rounded"></i>
                        </button>
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="d-flex mb-4 pb-1 align-items-center">
                            ...
                            <div class="row w-100 align-items-center">
                                ...
                                <div
                                    class="col-sm-4 col-lg-12 col-xxl-4 text-sm-end text-lg-start text-xxl-end">
        ...
        <div class="col-12 col-xl-4 col-md-6">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <p class="small">Next Generation Frontend Architecture Using Layout Engine
                        And React Native Web.</p>
                    ...
                    <a href="javascript:void(0);" class="btn btn-primary w-100">Join the
                        event</a>
                </div>
            </div>
        </div>
