                                                            ...
                                                            <div class="x_WordSection1">
                                                                ...
                                                                <p style="text-align:justify" class="x_MsoNormal">
                                                                    <span
                                                                        ...
                                                                        souhaitons vous informer que la réunion pour
                                                                        laquelle vous avez été invité concernant le
                                                                        dysfonctionnement n° {{ $dysfunction->code }}
                                                                        commence dans 1 heure précisément à
                                                                        {{ $invitation->begin }} et se tiendra à
                                                                        [{{ $invitation->place }}/{{ is_null($invitation->link) ? 'Aucun Lien Fourni' : '<a href="' . $invitation->link . '">Lien</a>' }}]
                                                                        comme annoncé. Nous vous remercions de votre
                                                                        présence.</span>
                                                                </p>
                                                            </div>
                                                        </table>
