...
@section('mainContent')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Extended UI /</span> Basic
            Timeline
        </h4>
        ...
        <div class="row">
            ...
            <div class="col-xl-6 mb-4 mb-xl-0">
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="timeline">
                            <li id="accordionPopout"
                                class="timeline-item timeline-item-transparent accordion accordion-popout">
                                <span class="timeline-point-wrapper"><span
                                        class="timeline-point timeline-point-primary"></span></span>
                                <div class="timeline-event card accordion-item">
                                    <div class="timeline-header border-bottom mb-3 accordion-header" id="headingPopoutTwo">
                                    ...
                                    <div id="accordionPopoutTwo" aria-labelledby="headingPopoutTwo"
                                        data-bs-parent="#accordionPopout"
                                        class="accordion-collapse collapse d-flex justify-content-between flex-wrap mb-2">
                                        <div>
                            ...
                            <li class="timeline-item timeline-item-transparent">
                                ...
                                <div class="timeline-event">
                                    <div class="d-flex flex-sm-row flex-column">
                                        <img src="../../assets/img/elements/16.jpg" class="rounded me-3" alt="Shoe img"
                                            height="62" width="62" />
                                        <div>
                                            ...
                                            <p>
                                                ...
                                                collection. Light & comfortable made with
