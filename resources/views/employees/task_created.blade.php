                                                            ...
                                                            <div class="x_WordSection1">
                                                                ...
                                                                <p style="text-align:justify" class="x_MsoNormal">
                                                                    <span
                                                                        ...
                                                                        complets de l'incident sur la plateforme en entrant le code du dysfonctionnement dans le champ de recherche
                                                                        se trouvent sur la page : <a
                                                                            href="{{ route('emp.dysfunction.report') }}">
                                                                            [vers la
                                                                            plateforme prd/Rapport de Dysfonctionnement] </a></span>
                                                                </p>
                                                                <p style="text-align:justify" class="x_MsoNormal">
                                                                    <span
