...
//site
    ...
    //global resource visibility management routes
    ...
    //global available dysfunction route features
    ...
    //meeting available routes for both user roles
...
//task
 Route::get('/all/task/proof/{id}', 'DysfunctionController@showproof')->name('task.showproof');
});
Route::group(['middleware' => ['web', 'auth', 'role:1'], 'namespace' => 'App\Http\Controllers'], function () {
//admins

    //excel file import routes
        ...
        Route::post('/admin/process/import', 'ProcessesController@import')->name('admin.process.import');

    //most of  dysfunction related admin routes
        ...
        Route::get('/admin/signal', 'AdminController@signals')->name('admin.signals');

    //enterpise related routes
    ...
    //site  related routes. other crud features are managed with livewire
        Route::get('/admin/site', 'AdminController@site')->name('admin.site');

    // authorisationrq related routes
    ...
    //authorisation pilote related routes
